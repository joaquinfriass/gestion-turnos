...
<head>
    ...
    <title>Editar usuario - Gestion de Turnos</title>
...
<body>
    ...
    <main class="main-content page-shell narrow">
        <header class="page-header"><div><a class="back-link" href="index.php?action=usuarios"><i class="bi bi-arrow-left"></i><span>Usuarios</span></a><h1>Editar usuario</h1></div></header>
        ...
        <section class="form-panel">
            <form action="index.php?action=usuarios_editar&id=<?php echo (int) $id; ?>" method="POST" class="row g-3 js-validate">
                ...
                <div class="col-12"><label class="form-label" for="password">Nueva contraseña</label><input class="form-control" type="password" id="password" name="password" placeholder="Dejar vacio para mantener"></div>
                <div class="form-actions"><a class="btn btn-outline-secondary" href="index.php?action=usuarios">Cancelar</a><button class="btn btn-primary" type="submit"><i class="bi bi-check-lg"></i><span>Actualizar usuario</span></button></div>
            </form>
        </section>
    </main>
    </div>
