...
<head>
    ...
    <title>Editar paciente - Gestion de Turnos</title>
...
<body>
    ...
    <main class="main-content page-shell narrow">
        <header class="page-header">
            <div>
                <a class="back-link" href="index.php?action=pacientes"><i class="bi bi-arrow-left"></i><span>Pacientes</span></a>
        ...
        <section class="form-panel">
            <form action="index.php?action=pacientes_editar&id=<?php echo (int) $id; ?>" method="POST" class="row g-3 js-validate">
                ...
                <div class="form-actions">
                    <a class="btn btn-outline-secondary" href="index.php?action=pacientes">Cancelar</a>
                    <button class="btn btn-primary" type="submit"><i class="bi bi-check-lg"></i><span>Actualizar paciente</span></button>
                </div>
            </form>
        </section>
    </main>
